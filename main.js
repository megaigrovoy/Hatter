...
const HAT_TYPES = {
    ...
    // Посадка заметно ниже кромки купола: шлем не лежит на голове, как шляпа,
    // а надевается глубоко — глазницы приходятся чуть выше глаз, нащёчники
    // спускаются вдоль щёк.
    viking: {
        id: 'viking',
        score: 75,
        wearable: true,
